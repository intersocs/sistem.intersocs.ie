...
function createOrUpdateSchedulesAndTopics(projectId, triggers, existingScheduledFunctions, appEngineLocation) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (triggersWithSchedules.length) {
            yield Promise.all([
                ensureApiEnabled_1.ensure(projectId, "cloudscheduler.googleapis.com", "scheduler"),
                ensureApiEnabled_1.ensure(projectId, "pubsub.googleapis.com", "pubsub"),
            ]);
            schedulerEnabled = true;
        }
        else {
            schedulerEnabled = yield ensureApiEnabled_1.check(projectId, "cloudscheduler.googleapis.com", "scheduler");
        }
