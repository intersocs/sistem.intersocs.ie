...
suite('BehaviorScanner', () => {
    ...
    test('Does not count methods as properties', function () {
        ...
        chai_1.assert.deepEqual([...behavior.properties.keys()], ['simple', 'object', 'array', 'attached', 'templateLiteral']);
    });
    test('Correctly transforms property types', function () {
        ...
        chai_1.assert.deepEqual([...behavior.properties.values()].map((p) => ({ name: p.name, type: p.type })), [
